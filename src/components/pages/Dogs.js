...
function Dogs() {
    return (
        <>
            <div className='container my-3' style={{ display: 'flex', justifyContent: 'space-evenly' }}>
                ...
                <div>
                    <button type="button" className="btn btn-success" style={{ width: '200px' }}>Search</button>
                </div>
            </div>

            <section className="section"  >
                <div className="card" style={{ display: 'flex' }}>
                    <div className="add-petN w-100" id="addropdown" style={{ textAlign: 'center' }}>
                        <span>Add Pet&nbsp;&nbsp;<i className="fa fa-plus" aria-hidden="true"></i></span>
                    </div>
                </div>
            </section>
            <Feed />
